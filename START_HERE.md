...
AI agents have a recurring failure mode on this project: responding to APF requests with fluent-but-wrong output because the relevant context was never loaded. This file is the minimum context load to reason about Paper 10 of the APF series honestly.
...
Expected output: `Paper 10 (The Calculus of Finite Continuability): N passed, 0 failed, N total — verified in under 1s`.
