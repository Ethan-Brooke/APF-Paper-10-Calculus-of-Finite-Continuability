# Reviewers' Guide — APF Paper 10: The Calculus of Finite Continuability

This guide is the physics-first walkthrough for peer reviewers of The Calculus of Finite Continuability. It addresses the structural assumptions, anticipated objections, and falsification surfaces of the paper's argument. The intended audience is a peer reviewer with a background in physics or mathematics.

The guide complements three other verification routes:
- The [executable codebase](apf/) (run `python run_checks.py` for the full 3-theorem verification);
- The [Colab notebook](APF_Reviewer_Walkthrough.ipynb) (zero-install, theorem-by-theorem cells with prose + code);
- The [interactive derivation DAG](https://ethan-brooke.github.io/Calculus-of-Finite-Continuability/) (hover-for-details, click-for-dependencies, animated verification).
...
To prevent scope inflation, the following are flagged explicitly as *outside* the scope of Calculus Finite Continuability:
...
- **`apf/core.py`** — the 3 theorem check functions for this paper. Each function constructs a mathematical witness, verifies the theorem's claim, and returns a structured result with name, dependencies, status, and key result.
...
This repository is the executable mathematical appendix to APF Paper 10. The canonical archival deposit is at [https://doi.org/10.5281/zenodo.20041680](https://doi.org/10.5281/zenodo.20041680) (DOI: 10.5281/zenodo.20041680).

---

*Generated by the APF `create-repo` skill on 2026-07-18. Codebase snapshot: v24.3.427 (frozen 2026-05-04; 3918 verify_all checks, 3918 bank-registered theorems, 48 quantitative predictions).*
