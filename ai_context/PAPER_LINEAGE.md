...
- **Version in this repo:** v1.12
- **File in this repo:** `Paper_10_Calculus_of_Finite_Continuability_v1.12.tex` + `.pdf`
- **Page count:** 16 pp
...
- **v1.12** (current): see the main paper's changelog section for details.
...
**vv1.12 supersedes all earlier versions** for current reference. If citing for strict reproducibility of work published before this version, cite the version DOI from the specific Zenodo deposit the earlier work used.
...
*Generated by `create-repo`. The `- **v1.12** (current): see the main paper's changelog section for details.
